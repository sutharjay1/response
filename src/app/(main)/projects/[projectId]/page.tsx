          ...
          <div className="mb-6 flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              {/* <Button
                  ...
                  className="reorder-handle inline-flex h-8 w-8 cursor-grab items-center rounded-xl border border-input bg-[#fff3ec]/80 p-0 text-xs font-semibold text-[#7c533a] transition-colors hover:bg-[#fff3ec]/80 hover:text-[#7c533a] focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                >
                  <Grid />
    ...
    <div className="relative mx-auto flex w-full flex-col items-center overflow-y-auto pb-12 sm:rounded-lg">
      ...
      <Card className="z-20 w-full max-w-screen-sm space-y-4 border-none pt-6 shadow-none md:col-span-1">
        ...
        {isInitialLoading || isLoading ? (
          ...
          <>
            <CardHeader className="flex flex-col items-start justify-center space-y-1 px-0 py-4">
              <CardTitle>
